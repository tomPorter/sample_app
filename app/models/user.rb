...
class User < ActiveRecord::Base
  ...
  before_save :encrypt_password #callback method to be executed
  ...
  def encrypt_password
    # Need self to allow modification outside of method!
    self.salt = make_salt if new_record?  #ActiveRecord method
